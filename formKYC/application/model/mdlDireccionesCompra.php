...
class mdlDireccionesCompra
{

  private $idShippingAddress;
  private $idAddresses;
  private $Country1;
  private $State1	;
  private $City1	;
  ...
  public function guardarDireccionC()
  {

    $sql="CALL SP_guardarShippingAddress (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
  ...
  {
    $sql="CALL SP_actualizarShippingAddress (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
