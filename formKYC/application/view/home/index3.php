...
<div class="inner_content">
  <div class="title-bar top-title">
    <h1 class="text-center font-maaji">Something Good</h1>
  </div>
  <div class="inner_content_w3_agile_info">
    <div class="agile_top_w3_grids">
      <div class="main-customers">
        <form class="form-horizontal" name="formcustomers3" id="form-customers3" action="#" autocomplete="off">
          <div class="row">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5 " id="hideOtherPayment">
              <div class="form-group">
              ...
              <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
                <div id="OthersPyment">
                  <div class="form-group">
                    <label for="Others"><span>¿Which one?</span> <span class="red">*</span></label>
                  </div>
                  <div class="form-group">
                    <?php foreach ($query3 as $value): ?>
                      <input type="text" name="others" id="Others" class="form-control" onkeyup="validarLargoWhichOne()" value="<?= $value['whichOne']; ?>">
                    <?php endforeach; ?>
                  </div>
                </div>
              <?php else: ?>
                <div id="OthersPyment">
                  ...
                  <div class="form-group">
                    <input type="text" name="others" id="Others" class="form-control" onkeyup="validarLargoWhichOne()">
                  </div>
                </div>
              <?php endif; ?>
            </div>
              ...
              <div class="form-group ul" id="ul">
                ...
                <label for="terms">&nbsp;¿Do you want to apply for credit terms?
                  <div class="li" id="li">
                    <i class="fa fa-question-circle" aria-hidden="true" title=""></i>
                    <span class="span">
                      The credit approval will be contingent entirely on Maaji´s
                      discretion and the Maaji´s internal credit policies
                    </span>
                  </div>
                </label>
              </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisotypeothhers" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
                  <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
                  <strong>Error!</strong>&nbsp;Which One is required
                </p>
              </div>

              <div class="alert alert-danger alert-dismissible ocultar" id="avisolargoatypeothers" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
                  <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
                  <strong>Error!</strong>&nbsp;Which One must have a minimum of 4 characters
                </p>
              </div>
          ...
          <?php require_once 'buyerContacts.php'; ?>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5">
              <div class="form-group">
                <label for="logisticContactName">Full Name <span class="red">*</span></label>
              </div>
              <div class="form-group">
                <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
                  <?php foreach ($query3 as $value): ?>
                    <input type="text" name="logisticcontactname" class="form-control" id="logisticContactName" onkeyup="validarLargoLogisticName()" value="<?= $value['logisticContactName']; ?>">
                  <?php endforeach; ?>
                <?php else: ?>
                  <input type="text" name="logisticcontactname" class="form-control" id="logisticContactName" onkeyup="validarLargoLogisticName()" value="">
                <?php endif; ?>
              </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1">
              <div class="form-group">
                <label for="logisticContactPhone">Phone <span class="red">*</span></label>
              </div>
              <div class="form-group">
                <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
                  <?php foreach ($query3 as $value): ?>
                    <input type="text" name="logisticcontactphone" class="form-control" id="logisticContactPhone" onkeyup="validarLargoLogisticPhone()" value="<?= $value['logisticContactPhone']; ?>">
                  <?php endforeach; ?>
                <?php else: ?>
                  <input type="text" name="logisticcontactphone" class="form-control" id="logisticContactPhone" onkeyup="validarLargoLogisticPhone()" value="">
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisologisticcontact" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisolargologisticname" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisologisticphone" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <!-- Alerta address largo -->
              <div class="alert alert-danger alert-dismissible ocultar" id="avisolargologisticphone" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5">
              <div class="form-group">
                <label for="logisticContactEmail">Email <span class="red">*</span></label>
              </div>
              <div class="form-group">
                <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
                  <?php foreach ($query3 as $value): ?>
                    <input type="text" name="logisticcontactemail" class="form-control" id="logisticContactEmail" onkeyup="ValidarLogisticEmail()" value="<?= $value['logisticContactEmail']; ?>">
                    <input type="hidden" name="idbuyer" class="form-control" id="idbuyyer" value="<?= $value['idBuyers']; ?>">
                  <?php endforeach; ?>
                <?php else: ?>
                  <input type="text" name="logisticcontactemail" class="form-control" id="logisticContactEmail" onkeyup="ValidarLogisticEmail()" value="">
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
              ...
              <!-- Alerta address largo -->
              <div class="alert alert-danger alert-dismissible ocultar" id="avisoformatologisticemail" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisologisticemail" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
              <center>
                <h2 class="title-buyer-contact">Accounts Payable</h2>
              </center>
            </div>
          </div>
          <br/>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5">
              <div class="form-group">
                <label for=acountsPayableName>Full Name <span class="red">*</span></label>
              </div>
              <div class="form-group">
                <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
                  <?php foreach ($query3 as $value): ?>
                    <input type="text" name="accountspayablename" class="form-control" id="acountsPayableName" onkeyup="validarLargoPayableName()" value="<?= $value['accountsPayableName']; ?>">
                  <?php endforeach; ?>
                <?php else: ?>
                  <input type="text" name="accountspayablename" class="form-control" id="acountsPayableName" onkeyup="validarLargoPayableName()" value="">
                <?php endif; ?>
              </div>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1">
              <div class="form-group">
                <label for="accountsPayablePhone">Phone <span class="red">*</span></label>
              </div>
              <div class="form-group">
                <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
                  <?php foreach ($query3 as $value): ?>
                    <input type="text" name="payablephone" class="form-control" id="accountsPayablePhone" onkeyup="validarLargoPayablePhone()" value="<?= $value['accountsPayablePhone']; ?>">
                  <?php endforeach; ?>
                <?php else: ?>
                  <input type="text" name="payablephone" class="form-control" id="accountsPayablePhone" onkeyup="validarLargoPayablePhone()" value="">
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
              <!-- Alerta address required -->
              <div class="alert alert-danger alert-dismissible ocultar" id="avisopayablename" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <!-- Alerta address largo -->
              <div class="alert alert-danger alert-dismissible ocultar" id="avisolargopayablename" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <!-- Alerta address required -->
              <div class="alert alert-danger alert-dismissible ocultar" id="avisopayablephone" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <!-- Alerta address largo -->
              <div class="alert alert-danger alert-dismissible ocultar" id="avisolargopayablephone" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5">
              <div class="form-group">
                <label for="accountsPayableEmail">Email <span class="red">*</span></label>
              </div>
              <div class="form-group">
                <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
                  <?php foreach ($query3 as $value): ?>
                    <input type="text" name="payableEmail" class="form-control" id="accountsPayableEmail" onkeyup="ValidarPayablerEmail()" value="<?= $value['accountsPayableEmail']; ?>">
                    <input type="hidden" name="idbuyyer" class="form-control" id="idbuyyer" value="<?= $value['idBuyers']; ?>">
                  <?php endforeach; ?>
                <?php else: ?>
                  <input type="text" name="payableEmail" class="form-control" id="accountsPayableEmail" onkeyup="ValidarPayablerEmail()" value="">
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
              ...
              <!-- Alerta address largo -->
              <div class="alert alert-danger alert-dismissible ocultar" id="avisoformatopayableemail" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisopayableEmail" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12">
              <center>
                <h2 class="address-title">Comercial References</h2>
              </center>
            </div>
          </div>
          <br/>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-7">
              <h2 class="title-reference-one">Reference One</h2>
            </div>
          </div>
          <br/>
          <br/>
          ...
          <div class="row">
            <?php if (isset($userBuyers) && $userBuyers != NULL): ?>
              ...
              <div class="col-sm-12 col-xs-12 col-md-3 col-lg-3 col-md-offset-1">
                <div class="form-group">
                  <button type="button" class="btn btn-warning" name="btn-update" onclick="validarFormCustomerUpdate3();">
