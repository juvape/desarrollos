<div class="row">
    <p class="text-afirmative">
      <strong>* Shipping address:  is that address where you want your package mailed to. </strong>
    </p>
</div>
  <div class="row">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
          <p class="text-afirmative">
            <strong>* If you more have one shipping address, please add by doing click in the button</strong>
          </p>
        </div>
        <div class="form-group">
