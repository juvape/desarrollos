  ...
  <div class="inner_content_w3_agile_info">
    <div class="agile_top_w3_grids">
      <div class="main-users">
        <form class="form-horizontal" name="formusers" id="form-users" action="#" autocomplete="off">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1">
              ...
              <div class="form-group">
                <input type="password" class="form-control"  name="password" id="password" onkeyup="validarPassword()">
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
             ...
             <div class="alert alert-danger alert-dismissible ocultar" id="avisopassword" role="alert">
               ...
               <p class="centrar">
                 <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
                 <strong>Error!</strong>&nbsp;The password can't have blank spaces and must have at least 8 characters
               </p>
             </div>
