...
<div class="inner_content">
  <div class="title-bar top-title">
    <h1 class="text-center font-maaji">We Are Building Something...</h1>
  </div>
  <div class="inner_content_w3_agile_info">
    <div class="agile_top_w3_grids">
      <div class="main-customers">
        <form class="form-horizontal" name="formcustomers2" id="form-customers2" action="#" autocomplete="off">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1">
              ...
              <div class="form-group">
                    ...
                    <!-- <select class="form-control" name="typecompany" id="typecompany" onchange="validarTypeCompany()" disabled="true"> -->
                      <?php foreach ($query2 as $value): ?>
                        <input type="text" value="<?= $value['typeCompany'];?>" name="typecompany" id="typecompany" class="form-control" onkeyup="();">
                      <?php endforeach; ?>

                <?php else: ?>
                  <input type="text" name="typecompany" value="" id="typecompany" class="form-control" onkeyup="validarLargoTypeCompany();">
                <?php endif; ?>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisotypecompany" role="alert">
               ...
               <div class="alert alert-danger alert-dismissible ocultar" id="avisotypecompanylargo" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="close">
                  <span aria-hidden="true">&times;</span>
                </button>
                <p class="centrar">
                  <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
                  <strong>Error!</strong>&nbsp;Type of Company must have a minimum of 3 characters
                </p>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1">
              <div class="form-group">
                <label for="idnumber">Legal Representive Id Number <span class="red">*</span></label>
              </div>
              <div class="form-group">
                <?php if (isset($userAddress) && $userAddress != NULL): ?>
                  <?php foreach ($query2 as $value): ?>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisonumber" role="alert">
                ...
                <p class="centrar">
                  <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
                  <strong>Error!</strong>&nbsp;Legal Representive Id Number is required
                </p>
              </div>
              ...
              <div class="alert alert-danger alert-dismissible ocultar" id="avisolargonumber" role="alert">
                ...
                <p class="centrar">
                  <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
                  <strong>Error!</strong>&nbsp;Legal Representive Id Number must have a minimum of 5 characters
                </p>
              </div>
            </div>
          </div>
    ...
    <?php require_once 'union2.php'; ?>
        <div class="alert alert-danger alert-dismissible ocultar" id="avisoquantitylocationsshipping" role="alert">
          <button type="button" class="close" data-dismiss="alert" aria-label="close">
            <span aria-hidden="true">&times;</span>
          </button>
          <p class="centrar">
            <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
            <strong>Error!</strong>&nbsp; The quantity of locations is required
          </p>
        </div>
