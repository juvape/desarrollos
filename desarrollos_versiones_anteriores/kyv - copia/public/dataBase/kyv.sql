...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-05-2019 a las 01:00:14
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_actualizarBusinessLocations` (IN `_idBusiness` INT, IN `_Country1` VARCHAR(50) CHARSET utf8, IN `_State1` VARCHAR(50) CHARSET utf8, IN `_City1` VARCHAR(50) CHARSET utf8, IN `_Address1` VARCHAR(100) CHARSET utf8, IN `_storeName1` VARCHAR(50) CHARSET utf8, IN `_ZipCode1` VARCHAR(10) CHARSET utf8, IN `_Country2` VARCHAR(50) CHARSET utf8, IN `_State2` VARCHAR(50) CHARSET utf8, IN `_City2` VARCHAR(50) CHARSET utf8, IN `_Address2` VARCHAR(100) CHARSET utf8, IN `_storeName2` VARCHAR(50) CHARSET utf8, IN `_ZipCode2` VARCHAR(10) CHARSET utf8, IN `_Country3` VARCHAR(50) CHARSET utf8, IN `_State3` VARCHAR(50) CHARSET utf8, IN `_City3` VARCHAR(50) CHARSET utf8, IN `_Address3` VARCHAR(100) CHARSET utf8, IN `_storeName3` VARCHAR(50) CHARSET utf8, IN `_ZipCode3` VARCHAR(10) CHARSET utf8, IN `_Country4` VARCHAR(50) CHARSET utf8, IN `_State4` VARCHAR(50) CHARSET utf8, IN `_City4` VARCHAR(50) CHARSET utf8, IN `_storeName4` VARCHAR(50) CHARSET utf8, IN `_Address4` VARCHAR(100) CHARSET utf8, IN `_ZipCode4` VARCHAR(10) CHARSET utf8, IN `_Country5` VARCHAR(50) CHARSET utf8, IN `_State5` VARCHAR(50) CHARSET utf8, IN `_City5` VARCHAR(50) CHARSET utf8, IN `_storeName5` VARCHAR(50) CHARSET utf8, IN `_Address5` VARCHAR(100) CHARSET utf8, IN `_ZipCode5` VARCHAR(10) CHARSET utf8)  BEGIN
	UPDATE businesslocations SET Country1 = _Country1, State1 = _State1, City1 = _City1, Address1 = _Address1, storeName1 = _storeName1, ZipCode1 = _ZipCode1, Country2 = _Country2, State2 = _State2, City2 = _City2, Address2 = _Address2, storeName2 = _storeName2, ZipCode2 = _ZipCode2, Country3 = _Country3, State3 = _State3, City3 = _City3, Address3 = _Address3, storeName3 = _storeName3, ZipCode3 = _ZipCode3, Country4 = _Country4, State4 = _State4, City4 = _City4, storeName4 = _storeName4, Address4 = _Address4, ZipCode4 = _ZipCode4, Country5 = _Country5, State5 = _State5, City5 = _City5, storeName5 = _storeName5, Address5 = _Address5, ZipCode5 = _ZipCode5 WHERE idBusiness = _idBusiness;
END$$
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_guardarBusinessLocations` (IN `_idBusiness` INT(11), IN `_Country1` VARCHAR(50) CHARSET utf8, IN `_State1` VARCHAR(50) CHARSET utf8, IN `_City1` VARCHAR(50) CHARSET utf8, IN `_Address1` VARCHAR(100) CHARSET utf8, IN `_storeName1` VARCHAR(50) CHARSET utf8, IN `_ZipCode1` VARCHAR(10) CHARSET utf8, IN `_Country2` VARCHAR(50) CHARSET utf8, IN `_State2` VARCHAR(50) CHARSET utf8, IN `_City2` VARCHAR(50) CHARSET utf8, IN `_Address2` VARCHAR(100) CHARSET utf8, IN `_storeName2` VARCHAR(50) CHARSET utf8, IN `_ZipCode2` VARCHAR(10) CHARSET utf8, IN `_Country3` VARCHAR(50) CHARSET utf8, IN `_State3` VARCHAR(50) CHARSET utf8, IN `_City3` VARCHAR(50) CHARSET utf8, IN `_Address3` VARCHAR(100) CHARSET utf8, IN `_storeName3` VARCHAR(50) CHARSET utf8, IN `_ZipCode3` VARCHAR(10) CHARSET utf8, IN `_Country4` VARCHAR(50) CHARSET utf8, IN `_State4` VARCHAR(50) CHARSET utf8, IN `_City4` VARCHAR(50) CHARSET utf8, IN `_storeName4` VARCHAR(50) CHARSET utf8, IN `_Address4` VARCHAR(100) CHARSET utf8, IN `_ZipCode4` VARCHAR(10) CHARSET utf8, IN `_Country5` VARCHAR(50) CHARSET utf8, IN `_State5` VARCHAR(50) CHARSET utf8, IN `_City5` VARCHAR(50) CHARSET utf8, IN `_storeName5` VARCHAR(50) CHARSET utf8, IN `_Address5` VARCHAR(100) CHARSET utf8, IN `_ZipCode5` VARCHAR(10) CHARSET utf8)  BEGIN
	INSERT INTO businesslocations (idBusiness, Country1, State1, City1, Address1, storeName1, ZipCode1, Country2, State2, City2, Address2, storeName2, ZipCode2, Country3, State3, City3, Address3, storeName3, ZipCode3, Country4, State4, City4, storeName4, Address4, ZipCode4, Country5, State5, City5, storeName5, Address5, ZipCode5) VALUES (_idBusiness, _Country1, _State1, _City1, _Address1, _storeName1, _ZipCode1, _Country2, _State2, _City2, _Address2, _storeName2, _ZipCode2, _Country3, _State3, _City3, _Address3, _storeName3, _ZipCode3, _Country4, _State4, _City4, _storeName4, _Address4, _ZipCode4, _Country5, _State5, _City5, _storeName5, _Address5, _ZipCode5);
END$$
...
INSERT INTO business (idBusiness, typeBusiness, linesBusiness, anualSalesFigures, marketPotentialBrand, businessLocation, webSite, certificateOfExistence, taxCertificate, checkSpecimen, legalID, usernameBusiness)
VALUES
(
	null,
    _typeBusiness,
...
INSERT INTO `adresses` (`idAddresses`, `username`, `taxId`, `typeCompany`, `owner`, `idNumber`, `phone`, `billingAddress`, `billingCity`, `billingState`, `billingCountry`, `billingZipCode`, `quantityLocations`, `dateUpdated`) VALUES
(1, 1, '3452167', 'Pathership', 'Juan', '3567832132', '23459012', 'Calle 12 # 23-34 Sur', 'Medellin', 'Antioquia', 'Colombia', '005623', '1', NULL);
...
INSERT INTO `buyers` (`idBuyers`, `username`, `currency`, `bankName`, `branch`, `accountNumber`, `paymentType`, `creditTerms`, `reference1Name`, `phoneReference1`, `emailReference1`, `reference2Name`, `phoneReference2`, `emailReference2`, `reference3Name`, `phoneReference3`, `emailReference3`, `buyerName`, `buyerPhone`, `buyerEmail`, `dateUpdated`) VALUES
(1, 1, 'COP', 'Bancolombia Modificado', 'Avenida Oriental Modificado', '00245769645 modifica', 'other', 'Aceptado', 'Juan', '2265712', 'juvape@hotmail.com', 'David', '2345678', 'david@micorreo.com', '', '', '', 'Juvape', '2346578', 'juan@yahoo.es', NULL);
...
INSERT INTO `customers` (`idCustomer`, `userName`, `companyName`, `brandName`, `email`, `phone`, `website`, `address`, `city`, `state`, `country`, `zipcode`, `facebook`, `instagram`, `twitter`, `dateUpdated`) VALUES
(1, 1, 'Artmode', 'Maaji', 'juan@gmail.com', '3042276', 'http://www.maaji.co', 'Calle 51 A Sur # 67-40', 'Medellín', 'Antioquia', 'Colombia', '050029', '', '@', '@', '2019-05-12');
...
INSERT INTO `shippingaddress` (`idShippingAddress`, `idAddresses`, `Country1`, `State1`, `City1`, `Address1`, `storeName1`, `ZipCode1`, `Country2`, `State2`, `City2`, `Address2`, `storeName2`, `ZipCode2`, `Country3`, `State3`, `City3`, `Address3`, `storeName3`, `ZipCode3`, `Country4`, `State4`, `City4`, `storeName4`, `Address4`, `ZipCode4`, `Contry5`, `State5`, `City5`, `storeName5`, `Address5`, `ZipCode5`, `dateUpdated`) VALUES
(1, 1, 'Colombia', 'antioquia', 'itagui', 'cra 34 # 12-09', 'max protect', '36723', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
INSERT INTO `users` (`idUser`, `email`, `password`, `estado`) VALUES
(1, 'juan@gmail.com', 'a7d579ba76398070eae654c30ff153a4c273272a', 'Activo');
...
--
ALTER TABLE `adresses`
  MODIFY `idAddresses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `buyers`
  MODIFY `idBuyers` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `shippingaddress`
  MODIFY `idShippingAddress` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
