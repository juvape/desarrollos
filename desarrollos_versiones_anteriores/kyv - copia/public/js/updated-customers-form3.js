...
function ValidarFormularioActualizacionForm3()
{
        ...
        document.formcustomers3.buyerphone.value != "" && document.formcustomers3.buyeremail.value != "")
    {
        ...
        $.ajax({
          ...
          processData: false,
          beforeSend: function(){
			      $("#exitoactualizacionForm3").hide('fast');
            $("#carga3").show("fast");
          },
...
function validarLargoCurrency()
{
  if (document.formcustomers3.currency.value.length < 3)
  {
      $("#avisolargocurrency").show('slow');
      $("#avisocurrency").hide('slow');
      document.formcustomers3.currency.style.border = "1px solid #f22012";
  }
