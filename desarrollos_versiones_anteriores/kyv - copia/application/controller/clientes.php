...
class Clientes extends Controller
{
  ...
  public function actualizacionDatosForm5()
  {
    ...
    if($archivo1 && $archivo2 && $archivo3 && $archivo4)
    {
      ...
      //Declaramos un  variable con la ruta donde guardaremos los archivos
      $directorio = 'C:/xampp/htdocs/PHP/kyv/public/documents/' . $user;
      ...
      //obtenemos todos los nombres de los ficheros
      $file1 = 'C:/xampp/htdocs/PHP/kyv/public/documents/' . $user . $name1 . '.' . $extension1;
      $file2 = 'C:/xampp/htdocs/PHP/kyv/public/documents/' . $user . $name2 . '.' . $extension2;
      $file3 = 'C:/xampp/htdocs/PHP/kyv/public/documents/' . $user . $name3 . '.' . $extension3;
      $file4 = 'C:/xampp/htdocs/PHP/kyv/public/documents/' . $user . $name4 . '.' . $extension4;
        ...
        if(in_array($_FILES['file1']['type'], $permitidos) &&
           ...
           ($_FILES['file4']['size'] <= $limite_kb * 1024))
        {
          $ruta1 = 'C:/xampp/htdocs/PHP/kyv/public/documents/'. $user . $nameFile1;
          $ruta2 = 'C:/xampp/htdocs/PHP/kyv/public/documents/'. $user . $nameFile2;
          $ruta3 = 'C:/xampp/htdocs/PHP/kyv/public/documents/'. $user . $nameFile3;
          $ruta4 = 'C:/xampp/htdocs/PHP/kyv/public/documents/'. $user . $nameFile4;
          $resultado1 = move_uploaded_file($_FILES['file1']['tmp_name'], $ruta1);
          $resultado2 = move_uploaded_file($_FILES['file2']['tmp_name'], $ruta2);
          $resultado3 = move_uploaded_file($_FILES['file3']['tmp_name'], $ruta3);
          $resultado4 = move_uploaded_file($_FILES['file4']['tmp_name'], $ruta4);
      ...
      foreach ($dataForm4 as $value3)
      {
        ...
        $this->mdlBusiness->__SET('anualSalesFigures', $value3['figures']);
        $this->mdlBusiness->__SET('marketPotentialBrand', ucwords($value3['potentialbrand']));
        $this->mdlBusiness->__SET('businessLocation', $value3['businesslocation']);

        if ($value3['businesslocation'] == "mas-5")
        {
          // $destinatario = "jmontoya@maaji.co";
          $destinatario = "jvargasp@maaji.co";
          //Titulo
          $asunto = "MAAJI BUSINESS LOCATION";
          //Cuerpo
          $cuerpo = "";
          $cuerpo = '
          <html>
          ...
          <body>
          <h1>Hola!';
          $cuerpo .=  $destinatario . '</h1>';
          $cuerpo .= '<p>Nuestro cliente internacional <strong>' . $_SESSION['COMPANYNAME'] . '/' . $_SESSION['NAMECUSTOMER'] . '</strong> ha indicado desde el formulario';
          $cuerpo .= ' que posee más de 5 ubicaciones de negocios y no fue posible guardar la información en la base de datos, ';
          $cuerpo .= 'por favor ponerse en contacto con él/ella y validar los datos.';
          $cuerpo .= '</p></body></html>';
          //cabecera
          $headers = "MIME-Version: 1.0\r\n";
          $headers .= "Content-type: text/html; charset=utf-8\r\n";
          //dirección del remitente
          $headers .= "From: Maaji <noreply@maaji.co>\r\n";
  ...
  public function actualizarForm5BusinessL()
  {
    ...
    foreach ($dataForm2 as $value2)
    {
      ...
      $this->mdlBusinessL->__SET('Country1', $value2['country1']);
      $this->mdlBusinessL->__SET('State1', $value2['state1']);
      $this->mdlBusinessL->__SET('City1', $value2['city1']);
      $this->mdlBusinessL->__SET('Address1', $value2['dirbusiness1']);
      $this->mdlBusinessL->__SET('storeName1', $value2['storename1']);
      $this->mdlBusinessL->__SET('ZipCode1', $value2['zipcode1']);
      $this->mdlBusinessL->__SET('Country2', $value2['country6']);
      $this->mdlBusinessL->__SET('State2', $value2['state6']);
      $this->mdlBusinessL->__SET('City2', $value2['city6']);
      $this->mdlBusinessL->__SET('Address2', $value2['dirbusiness2']);
      $this->mdlBusinessL->__SET('storeName2', $value2['storename6']);
      $this->mdlBusinessL->__SET('ZipCode2', $value2['zipcode6']);
      $this->mdlBusinessL->__SET('Country3', $value2['country03']);
      $this->mdlBusinessL->__SET('State3', $value2['state03']);
      $this->mdlBusinessL->__SET('City3', $value2['city03']);
      $this->mdlBusinessL->__SET('Address3', $value2['dirbusiness3']);
      $this->mdlBusinessL->__SET('storeName3', $value2['storename3']);
      $this->mdlBusinessL->__SET('ZipCode3', $value2['zipcode03']);
      $this->mdlBusinessL->__SET('Country4', $value2['country4']);
      $this->mdlBusinessL->__SET('State4', $value2['state4']);
      $this->mdlBusinessL->__SET('City4', $value2['city4']);
      $this->mdlBusinessL->__SET('storeName4', $value2['storename4']);
      $this->mdlBusinessL->__SET('Address4', $value2['dirbusiness4']);
      $this->mdlBusinessL->__SET('ZipCode4', $value2['zipcode4']);
      $this->mdlBusinessL->__SET('Contry5', $value2['country5']);
      $this->mdlBusinessL->__SET('State5', $value2['state5']);
      $this->mdlBusinessL->__SET('City5', $value2['city5']);
      $this->mdlBusinessL->__SET('storeName5', $value2['storename5']);
      $this->mdlBusinessL->__SET('Address5', $value2['dirbusiness5']);
      $this->mdlBusinessL->__SET('ZipCode5', $value2['zipcode5']);
