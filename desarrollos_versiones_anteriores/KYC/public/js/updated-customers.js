...
function ActualizarInformacionForm1()
{
        ...
        document.formcustomers1.zipcode.value != "")
    {
        ...
        var twitter = document.formcustomers1.twitter.value;
        var idCustomer = document.formcustomers1.idCustomer.value;

        $.ajax({
          url: url + 'clientes/actualizacionDatos',
          type: 'POST',
          data: formData,
          cache: false,
          contentType: false,
