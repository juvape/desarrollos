        ...
        <form class="form-horizontal" name="formcustomers" id="form-customers" action="#">
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3">
              <div class="form-group">
                <label for="tipo_diligencia" class="control-label">Tipo Diligencia<span class="red">*</span></label>
              </div>
              <div class="form-group">
                <select class="form-control" name="tipo_diligencia" onchange="tipoDiligencia()" id="tipo_diligencia">
                  <option value="">-----</option>
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 col-md-offset-1">
              ...
              <div class="form-group">
                <!-- <input type="text"  class="form-control" name="lugar_diligenciamiento" id="lugar_diligenciamiento" onkeyup="validarLugar()"> -->
          ...
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1">
              ...
              <div class="form-group">
                <!-- <input type="text" class="form-control"  name="nacimiento" id="nacimiento" placeholder="DD MM AA" onkeyup="ValidarNacimiento()"> -->
                <!-- <div class="input-group date" data-provide="datepicker"> -->
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="ciudad" id="ciudad" onchange="ValidarCiudad()">
                  <option value="">---</option>
          ...
          <div class="alert alert-danger alert-dismissible ocultar" id="avisodireccion" role="alert">
            <button type="button" class="close" data-dismiss="alert" aria-label="close">
              <span aria-hidden="true">&times;</span>
            </button>
            <p class="centrar">
              <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
              <strong>Error!</strong>&nbsp;La dirección es requerida
            </p>
          </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-5">
              ...
              <div class="form-group">
                <input class="form-control" type="email" name="email" id="email" onkeyup="ValidarCorreo()" onchange="ValidarExistenciaCorreo()">
              </div>
            </div>
            <div class="col-xs-12 col-sm-12 col-md-5 col-md-offset-1">
              <div class="form-group">
              ...
              <div class="form-group">
                <input type="text" class="form-control"  name="celular" id="celular" onkeyup="ValidarCelEmail()">
              </div>
            </div>
          </div>
          ...
          <div class="alert alert-danger alert-dismissible ocultar" id="avisolargocelular" role="alert">
            ...
            <p class="centrar">
              <i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;
              <strong>Error!</strong>&nbsp;El celular debe contener mínimo 5 caracteres
            </p>
          </div>
          ...
          <!-- Alert guardado exitoso -->
          <!-- <div class="container-prod ocultar" id="exitocorreo">
            <div class="alert alert-success alert-dismissible" role="alert">
              <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span ari-hidden="true">&times;</span></button>
              <p class="centrar">
                <i class="fa fa-check" aria-hidden="true"></i>&nbsp;
...
function ValidarDocumento()
{
    ...
    $.ajax({
      ...
      success: function(resp){
        ...
        if (resp == 1) {
          swal({
                title: "El documento ingresado ya existe en nuestra base de datos!",
                type: "error",
