...
>>>>>>> c04965bf8f3e3cd298220d812e59e7835cdef6e9
    ...
    if (document.formcustomers.ciudad.value == "")
    {
        $("#avisociudad").show('slow');
        document.formcustomers.ciudad.style.border = "1px solid #f22012";
    }

    if (document.formcustomers.ciudad.value != "")
    {
        $("#avisociudad").hide('slow');
        document.formcustomers.ciudad.style.border = "1px solid #17dd37";
    }
...
{
  if (document.formcustomers.celular.value.length < 10)
  {
